...
// function ResidentialCleaningListing() {
//   return (
...
// export default ResidentialCleaningListing;
        ...
        <div className="mt-20 grid gap-10 md:grid-cols-2 lg:grid-cols-3">
          {residentialCleaningServices.map((service) => (
            ...
            >
              ...
              <p className="text-lg text-gray-700 mb-6">{service.description}</p>
              <Link
  to={service.id === 'custom-cleaning' ? '/residential/CustomCleaning' : `/residential/${service.id}`}
  className="inline-flex items-center text-lg font-medium text-blue-600 hover:text-blue-500 transition-colors"
  aria-label={`Learn more about ${service.title}`}
>
  Learn more
