...
import hospitality from "../assets/images/street2.png"; // Replace with your image path
...
const packageDescriptions = {
  basic: "Essential cleaning for small guest spaces.",
  standard: "Thorough cleaning for hotels and resorts.",
  premium: "High-standard cleaning for luxury accommodations.",
};
 ...
 const [isBookingSummaryOpen, setIsBookingSummaryOpen] = useState(false);
  ...
  useEffect(() => {
    const fetchServiceDetails = async () => {
      try {
        const response = await fetch('http://localhost:8080/api/services/hospitality-cleaning');
...
>
  ...
  <span className="text-black">g</span>
          ...
          <p className="text-lg sm:text-xl lg:text-2xl text-gray-200 pt-5 max-w-2xl mx-auto">
            <span className="text-black">Elevate</span> guest experiences <span className="text-black">with our met</span>iculous cleaning services for h<span className="text-black">otels and res</span>orts
          </p>
