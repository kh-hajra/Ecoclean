...
import education from "../assets/images/street2.png"; // Replace with your image path
...
const packageDescriptions = {
  basic: "Basic cleaning for classrooms and offices.",
  standard: "Regular cleaning for schools and colleges.",
  premium: "Deep cleaning for large campuses and auditoriums.",
};
 ...
 const [isBookingSummaryOpen, setIsBookingSummaryOpen] = useState(false);
  ...
  useEffect(() => {
    const fetchServiceDetails = async () => {
      try {
        const response = await fetch('http://localhost:8080/api/services/educational-facility-cleaning');
    ...
    if (bookingDetails.date && bookingDetails.time && bookingDetails.location) {
      try {
        const queryParams = new URLSearchParams({
          ...
          service: "Educational Facility Cleaning",
  ...
  return (
    <div className="min-h-screen bg-[#f8f9ff]">
      ...
      <div className="relative lg:h-[400px] flex items-center justify-center overflow-hidden">
        ...
        />
        <div className="absolute z-10 text-center  max-w-8xl mt-2">
...
<span className="text-black">I</span>
  <span className="text-white">nstitutional C</span>
  <span className="text-black">lea</span>
  <span className="text-white">ning</span>
</h1>

          <p className="text-lg sm:text-xl lg:text-2xl text-gray-200 pt-5 max-w-2xl mx-auto">
            <span className="text-black">Create</span>  a clean and healthy <span className="text-black">learning en</span>vironment for students <span className="text-black">and staff.</span>
          </p>
