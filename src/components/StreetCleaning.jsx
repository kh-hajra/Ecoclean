...
import BookingSummaryModal from './BookingSummaryModal';// Add this import
...
const StreetCleaning = () => {
  ...
  useEffect(() => {
    const fetchServiceDetails = async () => {
      try {
        const response = await fetch('http://localhost:8080/api/services/street-cleaning');
...
const handleCleanerSelect = (cleaner) => {
  console.log('Selected cleaner data:', cleaner); // Debug log
      ...
      <div className="relative lg:h-[400px] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute z-10 text-center px-8 max-w-4xl mt-2">
          ...
          <h1 className="text-5xl sm:text-6xl lg:text-8xl font-bold tracking-tight leading-tight font-serif" 
            ...
            <span className="text-black">ning</span>
          </h1>
