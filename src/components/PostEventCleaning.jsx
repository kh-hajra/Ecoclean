...
const packageDescriptions = {
  basic: "Basic cleanup and restoration",
  standard: "Thorough cleaning and waste management",
  premium: "Complete venue restoration and deep cleaning",
};
  ...
  return (
    ...
    <div className="relative lg:h-[400px] flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute z-10 text-center px-8 max-w-4xl mt-2">
        ...
        <span className="text-white">Post-Event </span>
...
<p className="text-lg sm:text-xl lg:text-2xl text-gray-200 pt-5 max-w-3xl mx-auto text-center">
  <span className="text-black">Efficient po</span>st-event cleaning to <span className="text-black">restore your </span>venue to its original pristine <span className="text-black"> condition</span>.
</p>
