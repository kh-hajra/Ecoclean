...
import bathroomCleaningImage from "../assets/images/street2.png";
...
const packageDescriptions = {
  basic: "Basic bathroom cleaning including sink and toilet",
  standard: "Comprehensive cleaning including tiles and mirrors",
 ...
 const [isBookingSummaryOpen, setIsBookingSummaryOpen] = useState(false);
  ...
  useEffect(() => {
    const fetchServiceDetails = async () => {
      try {
        const response = await fetch('http://localhost:8080/api/services/bathroom-cleaning');
      ...
      <div className="relative lg:h-[400px] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute z-10 text-center px-8 max-w-4xl mt-2">
          ...
          <h1 className="text-6xl sm:text-7xl lg:text-8xl font-bold tracking-wide leading-tight font-serif whitespace-nowrap" style={{ fontFamily: 'Rische, serif' }}>
            <span className="text-white">Bathroom Cleaning</span>
          </h1>
          <p className="text-lg sm:text-xl lg:text-2xl text-gray-200 pt-5 max-w-3xl mx-auto text-center">
            <span className="text-black">Thorough</span> cleaning services for your <span className="text-black">bathroom</span> to ensure a spotless and hygienic environment.
          </p>
