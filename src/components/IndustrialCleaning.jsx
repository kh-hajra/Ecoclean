...
import industrial from "../assets/images/street2.png"; // Replace with your image path
...
const packageDescriptions = {
  basic: "Surface cleaning for light industrial areas.",
  standard: "Routine cleaning for factories and warehouses.",
  premium: "Intensive cleaning for heavy-duty environments.",
};
 ...
 const [isBookingSummaryOpen, setIsBookingSummaryOpen] = useState(false);
  ...
  useEffect(() => {
    const fetchServiceDetails = async () => {
      try {
        const response = await fetch('http://localhost:8080/api/services/industrial-cleaning');
...
>
  <span className="text-white">Industrial Cl</span>
  ...
  <span className="text-white">ning</span>
          ...
          <p className="text-lg sm:text-xl lg:text-2xl text-gray-200 pt-5 max-w-2xl mx-auto">
            Specialized indu<span className="text-black">strial cleaning </span>solutions for factories,wareh<span className="text-black">ouses,and  industrial</span> facilities.
          </p>
