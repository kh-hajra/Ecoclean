...
import retail from "../assets/images/street2.png"; // Replace with your image path
...
const packageDescriptions = {
  basic: "General cleaning for small retail stores.",
  standard: "Detailed cleaning for shopping outlets.",
  premium: "Comprehensive cleaning for malls and large stores.",
};
...
const RetailCleaning = () => {
  ...
  useEffect(() => {
    const fetchServiceDetails = async () => {
      try {
        const response = await fetch('http://localhost:8080/api/services/retail-cleaning');
      ...
      <div className="relative lg:h-[400px] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute z-10 text-center px-8 max-w-4xl mt-2">
          ...
          <h1 className="text-6xl sm:text-7xl lg:text-8xl font-bold tracking-wide leading-tight font-serif" style={{ fontFamily: 'Rische, serif' }}>
            <span className="text-white">Retail Clea</span>
            <span className="text-black">nin</span>
            <span className="text-white">g</span>
          </h1>
          <p className="text-lg sm:text-xl lg:text-2xl text-gray-200 pt-5 max-w-2xl mx-auto">
          <span className="text-black">Main</span>tain a  spotless shop<span className="text-black">ping environ</span>ment  that attracts and ret<span className="text-black">ains customers</span> 
          </p>
