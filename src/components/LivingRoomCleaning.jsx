...
import livingRoomCleaningImage from "../assets/images/street2.png";
...
const packageDescriptions = {
  basic: "Basic living room cleaning including dusting and vacuuming",
  standard: "Comprehensive cleaning including furniture and windows",
  premium: "Deep cleaning with upholstery and carpet cleaning",
};
 ...
 const [isBookingSummaryOpen, setIsBookingSummaryOpen] = useState(false);
  ...
  useEffect(() => {
    const fetchServiceDetails = async () => {
      try {
        const response = await fetch('http://localhost:8080/api/services/living-room-cleaning');
      ...
      <div className="relative lg:h-[400px] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute z-10 text-center px-8 max-w-4xl mt-2">
          ...
          <h1 className="text-6xl sm:text-7xl lg:text-8xl font-bold tracking-wide leading-tight font-serif whitespace-nowrap" style={{ fontFamily: 'Rische, serif' }}>
            <span className="text-white">Living Room Cleaning</span>
          </h1>
...
export default LivingRoomCleaning;